...
const callsFromEntryPointMethodSigs: {[key: string]: string} = {
  factory: SenderCreator__factory.createInterface().getFunction('createSender').selector,
  account: IAccount__factory.createInterface().getFunction('validateUserOp').selector,
  paymaster: IPaymaster__factory.createInterface().getFunction('validatePaymasterUserOp').selector
}
